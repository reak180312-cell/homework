...
const MONSTERS = [
  ...
  { id: 'pebble', art: true, name: 'Threshold', rarity: 'common', colour: '#8fae6f',
  ...
  { id: 'kip', art: true, name: 'Filigree', rarity: 'legendary', colour: '#b59669',
  ...
  { id: 'vex', art: true, name: 'Cairn', rarity: 'uncommon', colour: '#bca262',
  ...
  { id: 'ash', art: true, name: 'Inkblot', rarity: 'uncommon', colour: '#6b7db2',
